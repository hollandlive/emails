...
//Header
$headerImage = "/emails/images/BMW_responsive";
...
<head>
    ...
    <style type="text/css">
        ...
        $tableStyle = "background-color:yellow;border:1px;border-color:green;width:580px";
...
<!--begin table wrapper-->
<table align="center" width="100%" style="<?php echo $tableStyle; ?>">
    <tr>
        <td>
            hyguy
        </td>
